...
for (i in 1:length(scaflist)){
  ...
  #identify outliers
  outliers <- rbind(inscaf[which(inscaf$zscore > 3),],
                    inscaf[which(inscaf$zscore < -3),])
...
pdf('davidsonii_x_newberryi_f_dM_window_1000-500.pdf')
for (i in 1:length(scaflist)){
...
pdf('newberryi_x_rupicola_SHASTA_f_dM_window_1000-500.pdf')
for (i in 1:length(scaflist)){
  print(get(paste("p", i, sep = "")))
}
dev.off()
...
pdf('newberryi_x_rupicola_NO-SHASTA_f_dM_window_1000-500.pdf')
for (i in 1:length(scaflist)){
  print(get(paste("p", i, sep = "")))
}
dev.off()
...
pdf('davidsonii_x_rupicola_CRATERLAKE_f_dM_window_1000-500.pdf')
for (i in 1:length(scaflist)){
  print(get(paste("p", i, sep = "")))
}
dev.off()
...
pdf('fruticosus_introgression_f_dM_window_1000-500.pdf')
for (i in 1:length(scaflist)){
  print(get(paste("p", i, sep = "")))
}
dev.off()
