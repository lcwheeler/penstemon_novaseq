...
input_trees="/work/lw74/habro/twisst_analysis/target_trios/Habroanthus_window_trees_concatenated.trees"
outfile="/work/lw74/habro/twisst_analysis/target_trios/output_windows_astral_tree.weights.csv.gz"
groupsfile="/work/lw74/habro/twisst_analysis/target_trios/groups.tsv"
outdir="/work/lw74/habro/twisst_analysis/target_trios"
...
python $twisst_loc/twisst.py -t $input_trees \
 -w $outdir/virgatus_barbatus_eatonii.weights.txt.gz \
 -g virgatus -g barbatus -g eatonii -g palmeri --outgroup palmeri \
 --method complete --groupsFile $groupsfile

python $twisst_loc/twisst.py -t $input_trees \
 -w $outdir/laevis_eatonii_barbatus.weights.txt.gz \
...
python $twisst_loc/twisst.py -t $input_trees \
 -w $outdir/virgatus_barbatus_labrosus.weights.txt.gz \
 -g virgatus -g barbatus -g labrosus -g palmeri --outgroup palmeri \
 --method complete --groupsFile $groupsfile

python $twisst_loc/twisst.py -t $input_trees \
 -w $outdir/putus_labrosus_barbatus.weights.txt.gz \
...
python $twisst_loc/twisst.py -t $input_trees \
 -w $outdir/virgatus_barbatus_cardinalis.weights.txt.gz \
...
python $twisst_loc/twisst.py -t $input_trees \
 -w $outdir/laevis_eatonii_labrosus.weights.txt.gz \
 -g laevis -g eatonii -g labrosus -g palmeri --outgroup palmeri \
 --method complete --groupsFile $groupsfile

python $twisst_loc/twisst.py -t $input_trees \
 -w $outdir/putus_labrosus_eatonii.weights.txt.gz \
...
python $twisst_loc/twisst.py -t $input_trees \
 -w $outdir/laevis_eatonii_cardinalis.weights.txt.gz \
...
python $twisst_loc/twisst.py -t $input_trees \
 -w $outdir/putus_labrosus_cardinalis.weights.txt.gz \
